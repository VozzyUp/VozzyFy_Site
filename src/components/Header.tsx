        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-2 text-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-foreground">
              Plataforma Oficial Getfy - Única Original
            </span>
          </div>
          <span className="text-xs text-muted-foreground hidden md:inline">
            Esta é a plataforma Getfy oficial e original. Versões vendidas por terceiros são clonadas.
          </span>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-foreground">getfy</span>
            </div>
