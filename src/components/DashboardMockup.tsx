...
const DashboardMockup = () => {
  ...
  return <div className="glass-card rounded-2xl p-6 md:p-8 glow-primary max-w-5xl mx-auto">
      {/* Header */}
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Fernando Rodrigues</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
        {statsTop.map((stat, i) => <div key={i} className="bg-secondary/50 rounded-xl p-4 border border-border/50">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        {statsBottom.map((stat, i) => <div key={i} className="bg-secondary/30 rounded-xl p-4 border border-border/30">
            <div className="flex items-center gap-2 mb-2">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="bg-secondary/30 rounded-xl p-4 border border-border/30">
          ...
          <div className="flex items-end justify-between h-32 gap-2">
            {salesData.map((item, i) => <div key={i} className="flex flex-col items-center flex-1">
                <div className="w-full bg-gradient-to-t from-primary to-emerald-400 rounded-t-md" style={{
